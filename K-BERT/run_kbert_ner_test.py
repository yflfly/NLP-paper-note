...
def main():
    ...
    parser.add_argument("--pretrained_model_path", default=None, type=str,
                        help="Path of the pretrained model.")  # 预训练模型 是从指定的网址下载的模型
    parser.add_argument("--output_model_path", default="./models/tagger_model.bin", type=str,
                        help="Path of the output model.")  #
    parser.add_argument("--vocab_path", default="./models/google_vocab.txt", type=str,
                        help="Path of the vocabulary file.")
    parser.add_argument("--train_path", type=str, required=True,
                        help="Path of the trainset.")  # 训练集train数据的存放位置
    parser.add_argument("--dev_path", type=str, required=True,
                        help="Path of the devset.")  # 开发集dev数据的存放位置
    parser.add_argument("--test_path", type=str, required=True,
                        help="Path of the testset.")  # 测试集test数据的存放位置
    parser.add_argument("--config_path", default="./models/google_config.json", type=str,
                        help="Path of the config file.")  # 参数设置
    ...
    parser.add_argument("--encoder", choices=["bert", "lstm", "gru", \
                        ...
                        default="bert", help="Encoder type.")  # 编码器的选择
    ...
    # 控制 训练模型 还是 测试模型
    parser.add_argument("--train_or_test", type=bool, default=True, help="judge train or test")
            ...
            for l in labels:
                if l not in labels_map:
                    if l.startswith("B") or l.startswith("S"):
                        begin_ids.append(len(labels_map))  # 存储B- 的label-id
